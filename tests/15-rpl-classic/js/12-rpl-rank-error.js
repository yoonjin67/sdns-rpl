...
GENERATE_MSG(4800000, 'randomize-nodes');

for(var n=0;n<10;n++) {
    GENERATE_MSG(n*800000, 'get-pdr');
}
...
TIMEOUT(8000000, if(packetsReceived.length > 50) { log.testOK(); } );
...
while(true) {
    ...
    } else if(msg.startsWith('get-pdr')) {
