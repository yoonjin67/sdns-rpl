...
GENERATE_MSG(00000, 'randomize-nodes');
GENERATE_MSG(120000, 'randomize-nodes');
GENERATE_MSG(240000, 'randomize-nodes');
GENERATE_MSG(360000, 'randomize-nodes');
...
TIMEOUT(6840000, if(packetsReceived.length/packetsSent.length*100>70) { log.testOK(); } );
